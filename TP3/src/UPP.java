...
class UPPLoad extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
    	  PRegister paddr = addr.getPRegister(locals);
          return new RTLLoad(paddr, reg, succ);
    }//toRTL
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
    	...
    	ArrayList<PRegister> argsReturn = new ArrayList<PRegister>();
    	for(UPPExpr i : args){
    		PRegister toAdd = i.getPRegister(locals);
    		argsReturn.add(toAdd);
    	}
        
    	return new RTLProcCall (callee,argsReturn, succ);
    }//toRTL
